...
- **Accent**: Soft, high-readability pastel tags for categorization (bg-opacity-20).

## Typography
- **Headings**: Geist Sans (Sans-serif), Bold/Extrabold, tight tracking. Mixed case (Standard capitalization).
- **Body**: Geist Sans, Regular/Medium weight, leading-relaxed.
- **Monospace**: Geist Mono for technical components.

## Layout
- **Container**: Max-width 6xl (1152px) for pages, 4xl (896px) for articles.
- **Radius**: Standard 0.5rem (8px) for small elements, large 2rem+ for sections and cards to maintain a premium look.
- **Spacing**: Significant vertical breathing room (py-24+) between major sections.
